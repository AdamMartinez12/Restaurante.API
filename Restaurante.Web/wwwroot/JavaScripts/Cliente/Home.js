$(document).ready(function () {
    ...
    //    "serverSide": true,
    //    "ajax": {
    //        url: "https://localhost:44312/Cliente",
    //        type: 'GET',
    //        data: function (d) {
    ...
    //        },
    //        { "name": "clienteId", "data": "clienteId", "targets": 0, "visible": true },
    //        { "name": "nombre", "data": "nombre", "targets": 1 },
    //        {
    //            "name": "Telefono", "data": "telefono", "targets": 2,
    //            "render": function (data, type, row) {
    //                if (!data) return ''; // Manejo de valores nulos o vacío
    //                return data; // Si hay un teléfono, lo retorna
    //            }
    //        },
    //        { "name": "email", "data": "email", "targets": 3 }
    //    ], // Aquí se cerró correctamente el array de columnDefs
    //    "order": [[0, "desc"]], // Ordenar por la primera columna (clienteId)
    //    "language": {
    ...
    var table = $('#tabla').DataTable({
        ...
        ajax: {
            ...
            dataSrc: function (json) {
                // Adapta la respuesta de la API para cumplir con el formato esperado
                return json.map(function (item) {
                    return {
                        clienteId: item.clienteId,
                        nombre: item.nombre,
                        telefono: item.telefono || "No Disponible", // Manejo de valores nulos
        ...
        columns: [
            { data: 'clienteId', title: 'ID Cliente' },
            ...
            { data: 'email', title: 'Email' },
            {
                ...
                render: function (data, type, row) {
                    return `
                    <button class="btn btn-primary btn-sm me-2 btn-editar" data-id="${row.clienteId}">
                        <i class="fas fa-pen"></i> Editar
                    </button>
                    <button class="btn btn-danger btn-sm btn-eliminar" data-id="${row.clienteId}">
